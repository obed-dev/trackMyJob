        ...
        <table className="min-w-full bg-color4 dark:bg-darkBackground border border-color1 dark:border-darkColor1 rounded-lg shadow-lg">
          <thead>
            <tr className="bg-white dark:bg-darkColor2 text-color1 dark:text-darkText uppercase text-sm leading-normal">
              <th className="py-3 px-6 text-left text-lg font-bold font-montserrat">Date</th>
              <th className="py-3 px-6 text-left text-lg font-bold font-montserrat">Title</th>
              <th className="py-3 px-6 text-left text-lg font-bold font-montserrat">Company</th>
              <th className="py-3 px-6 text-left text-lg font-bold font-montserrat">Actions</th>
            </tr>
          </thead>
